...
router.delete('/:egID', (req, res) => {
    const egID = req.params.egID 
    const found = investors.some(investor => investor.egID === egID)
    if(found){
    const investor = investors.find(investor => investor.egID === egID)
...
//editing yara
router.put('/:egID',(req,res)=>{
    investors.filter((investor) => {
      if (req.params.egID == investor.egID){
